...
and then install any of the launchers you'll use:
    ...
    npm install karma-chrome-launcher karma-firefox-launcher karma-safari-launcher karma-opera-launcher karma-ie-launcher --save-dev
